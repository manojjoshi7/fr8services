...
<div class="row">
                    <div class="col-lg-5">
                     <h3>Current Roaster (<?php echo $startenddate[0]->start_date;?> / <?php echo $startenddate[0]->end_date;?>)</h3>   
                    </div>
					<div class="col-lg-5">
<?php 

$attributes = array('class' => '', 'id' => 'prevform','name'=>'prevform');
echo form_open('admin/helperdisplayhourlyjob',$attributes);
